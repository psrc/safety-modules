    ...
    output$afooter <- renderUI({
      ...
      bs4Jumbotron(
        ...
        title =  strong(div(class="footer_title",
                   ...
                   hr(),
                   fluidRow(column(6, "Our Mission"),
                            column(6, HTML("&emsp;Our Values")))
                       )),
        lead = div(class="footer_mission",  
                   fluidRow(column(6, mission),
                            column(6, HTML("&emsp;Lead with <b>Racial Equity</b> &emsp;&emsp;&emsp; Pursue <b>Excellence</b><br/>
